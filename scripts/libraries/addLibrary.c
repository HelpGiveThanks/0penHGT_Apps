September 10, 2018 16:59:14 0penHGT_Apps.fmp12 - addLibrary -1-
...
Show Custom Dialog [ Message: "FYI: An open library deleted from this list, using the X button, cannot be added back ot this list
